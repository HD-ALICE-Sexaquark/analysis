...
void runAnalysis(Bool_t IsMC, TString RunPeriod, Int_t ChooseNEvents = 0) {
    ...
    */
    ...
    // load lambda1520 task
    gInterpreter->LoadMacro("AliAnalysisTaskLambda1520Lpipi.cxx++g");
    AliAnalysisTaskLambda1520Lpipi *task =
        reinterpret_cast<AliAnalysisTaskLambda1520Lpipi *>(gInterpreter->ExecuteMacro(Form("AddTask_Lambda1520Lpipi.C(\"name\", %i)", (Int_t)IsMC)));
