AliAnalysisTaskLambda1520Lpipi* AddTask_Lambda1520Lpipi(TString name = "name", Bool_t IsMC = kTRUE) {
    ...
    AliAnalysisTaskLambda1520Lpipi* task = new AliAnalysisTaskLambda1520Lpipi(name, IsMC);
