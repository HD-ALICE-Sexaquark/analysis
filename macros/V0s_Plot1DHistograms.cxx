    ...
    while (TTree *this_tree = (TTree *)list_of_trees_it->Next()) {
        ...
        for (Int_t event = 0; event < this_tree->GetEntries(); event++) {
            ...
            for (Int_t v0 = 0; v0 < this_event.N_V0s; v0++) {
                ...
                Float_t v0_radius =
                    TMath::Sqrt((*this_event.V0_X)[v0] * (*this_event.V0_X)[v0] + (*this_event.V0_Y)[v0] * (*this_event.V0_Y)[v0]);
                Float_t v0_pt =
                ...
                for (Int_t dau : {(*this_event.Idx_Neg)[v0], (*this_event.Idx_Pos)[v0]}) {
                    ...
                    Float_t dau_pt = TMath::Sqrt((*this_event.Rec_Px)[dau] * (*this_event.Rec_Px)[dau] +
                                                 (*this_event.Rec_Py)[dau] * (*this_event.Rec_Py)[dau]);
