...
void SimpleGen_DisplacementDuePV(Int_t N = 25000) {
    ...
    // create a ROOT file
    TFile* file = new TFile("SimpleGen_DisplacementDuePV.root", "RECREATE");

    // prepare TTree
    TTree* tree = new TTree("IC", "SimpleGen_DisplacementDuePV");
