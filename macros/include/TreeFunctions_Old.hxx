...
struct Event_tt {
  ...
  std::vector<Bool_t>* Rec_isDuplicate_v1 = 0;  // kTRUE if track is a duplicate, kFALSE if not (v1: compared to true particle)
  std::vector<Bool_t>* Rec_isDuplicate_v2 = 0;  // kTRUE if track is a duplicate, kFALSE if not (v2: compared to similar particles)
...
void LoadBranches(TTree* this_tree, Event_tt& this_event) {
  ...
  this_tree->SetBranchAddress("MC_Gen", &this_event.MC_Gen);
  ...
  this_tree->SetBranchAddress("Rec_isDuplicate_v1", &this_event.Rec_isDuplicate_v1);
  this_tree->SetBranchAddress("Rec_isDuplicate_v2", &this_event.Rec_isDuplicate_v2);
