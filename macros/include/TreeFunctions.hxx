...
struct Event_tt {
    ...
    // [based on AliAnalysisTaskSexaquark.h]
    //
    ...
    std::vector<Float_t>* MC_Xf = 0;             // x-coordinate of generation vertex
    std::vector<Float_t>* MC_Yf = 0;             // y-coordinate of generation vertex
    std::vector<Float_t>* MC_Zf = 0;             // z-coordinate of generation vertex
    ...
    std::vector<Int_t>* MC_NDaughters = 0;       // number of daughters
    ...
    std::vector<Float_t>* Rec_HelixParam0 = 0;   // helix param. 0
    std::vector<Float_t>* Rec_HelixParam1 = 0;   // helix param. 1
    std::vector<Float_t>* Rec_HelixParam2 = 0;   // helix param. 2
    std::vector<Float_t>* Rec_HelixParam3 = 0;   // helix param. 3
    std::vector<Float_t>* Rec_HelixParam4 = 0;   // helix param. 4
    std::vector<Float_t>* Rec_HelixParam5 = 0;   // helix param. 5
...
void LoadBranches(TTree* this_tree, Event_tt& this_event) {
    ...
    this_tree->SetBranchAddress("MC_PID_Mother", &this_event.MC_PID_Mother);
    this_tree->SetBranchAddress("MC_PID_GrandMother", &this_event.MC_PID_GrandMother);
