AliAnalysisTaskAntiNeutronInteraction* AddTask_AntiNeutronInteraction(TString name = "name", Bool_t IsMC = kTRUE) {
    ...
    AliAnalysisTaskAntiNeutronInteraction* task = new AliAnalysisTaskAntiNeutronInteraction(name, IsMC);
