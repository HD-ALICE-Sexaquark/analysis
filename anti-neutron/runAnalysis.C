...
void runAnalysis(Bool_t IsMC, TString RunPeriod, Int_t ChooseNEvents = 0) {
    ...
    */
    ...
    // load anti-neutron interaction task
    gInterpreter->LoadMacro("AliAnalysisTaskAntiNeutronInteraction.cxx++g");
    AliAnalysisTaskAntiNeutronInteraction *task = reinterpret_cast<AliAnalysisTaskAntiNeutronInteraction *>(
        gInterpreter->ExecuteMacro(Form("AddTask_AntiNeutronInteraction.C(\"name\", %i)", (Int_t)IsMC)));
